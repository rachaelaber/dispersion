...
plot(new_cases_subset[1862, ] ~ days,  ylab = "Wald test p-value = 0.017", 
     xlab = "Date", ylim = c(0, 1400)) 
abline(v = american_thanksgiving, col = 2)

plot(new_cases_subset[1863, ] ~ days, ylab = "Wald test p_value = 0.099", 
     xlab ="Date", ylim = c(0, 1400)) 
abline(v = american_thanksgiving, col = 2)

plot(curves[220, ] ~ days, ylab = "Wald test p-value = 0.004", 
     xlab = "Date", ylim = c(0, 1400))
abline(v = american_thanksgiving, col = 2)

plot(curves[212, ] ~ days, ylab = "Wald test p-value = 0.260", 
     xlab = "Date", ylim = c(0, 1400))
abline(v = american_thanksgiving, col = 2)
