...
{![Figure 2A. (1) Simulated p-values for the Wald test](./figures/pvals_sim_Wald.pdf){width=33%}![(2) Simulated p-values for the Likelihood-Ratio test](./figures/pvals_sim_LRT.pdf){width=33%}!
}
