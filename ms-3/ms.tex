...
Analysis of the shape of epidemic curves for influenza in cities also aids public health planning by identifying contexts where incidence is focussed more intensely (proportionally more infections in a smaller span of time) with relevance for surge capacity in the health system~\cite{dalziel2018urbanization, wallinga2018metropolitan}. 
...
\begin{equation}
    \mathrm{I_{t+1}} = NB(\mu = \lambda R_t I_t, \theta_t = I_t)
\end{equation}
