...
Understanding patterns in infectious disease incidence is crucial for understanding epidemic dynamics and for developing effective public health responses, but traditional metrics often overlook the inherent variability in how viruses like SARS-CoV-2 (the virus that causes COVID-19) spread. Quantifying this variability (higher-frequency variation around incidence trends) can elucidate important underlying processes such as transmission heterogeneity. 
...
We apply the method to incidence data in 144 US counties from the January 1st, 2020 to March 23rd, 2023, and find that conspicuous shifts in dispersion occur across counties concurrently, and that these shifts are not explained by incidence alone. 
Around incidence peaks, dispersion increased spread, with some individuals potentially spreading the virus to many more people than others. 
...
Shifts in dispersion can indicate shifts in epidemic phase and information about underlying drivers of transmission, so our method to accurately measure disperison regardless of population size and incidence, provides a way to help public health officials anticipate and manage outbreaks.
