...
![Figure 1. Empirical increase in dispersion](./figures/empirical_increase.pdf)
...
![Figure 2A. (1) Simulated p-values for the Wald test](./figures/pvals_sim_Wald.pdf)
![(2) Simulated p-values for the Likelihood-Ratio test](./figures/pvals_sim_LRT.pdf)

There appears to be slight Type I error inflation in both tests. 

![Figure 2B. Mapping the Thanksgiving hypothesis across the US](./figures/map_Wald_US.pdf)

![Figure 3. Scanning for breakpoints using the LRT statistic](./figures/LRT_scan_figure.pdf)

In some time windows, the Likelihood-Ratio statistic can't be computed because (TODO**: the weight matrix in the IRLS can't be calculated?).
