...
signif_index <- state_index[(which(pvals < 0.05))]
...
Note that in these visualizations to check the relationship between mean and dispersion, an NB2 fit would be:
...
mean(pvals[which(curve_parms$theta1 == curve_parms$theta2)] < 0.05)
mean(pvals[which(curve_parms$theta1 != curve_parms$theta2)] < 0.05)
