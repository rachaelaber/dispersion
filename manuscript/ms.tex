...
Time series of infectious disease incidence are, to varying degrees, ``noisy'', showing higher frequency oscillations around trends at broader temporal scales.
...
\section*{Discussion}
We presented an approach to compare dispersion in epidemic time series that does not detect artifacts based on population size and incidence. 
