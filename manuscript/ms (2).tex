...
\caption{
Incidence and dispersion between 2020-01-04 and 2023-03-18 in large counties in the US. a: Mean COVID-19 cases of the 144 US counties over time. b: Mean $log_{10}\theta$ of the 144 US counties over time. Dashed line represents expected value of $log_{10}\theta_0$ under the null model in Equation 1. c: log10(case counts) - log10(reporting rate) over time for each of the large counties (y-axis). This again represents $log_{10}\theta_0$ under the model in Equation 1. d: $log_{10}\theta$ over time for each of the large counties (y-axis). e: Binned $log_{10}\theta_0$ for all counties over time. f: LRT p-values over time for each of the large counties (y-axis).
}
\label{fig3}
\end{figure}
