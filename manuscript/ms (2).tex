...
\end{equation}
A persistent challenge in investigating changes in incidence dispersion the statistical impact of population size on dispersion. 
...
Accordingly, population size appears as an offset in our model of broad-scale incidence changes.
Letting $I_t$ be the number of infections at time $t$ in a population of size $N$, equation (x) implies
\begin{equation}
